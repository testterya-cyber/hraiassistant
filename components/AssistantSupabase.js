...
function promptProfile(text) { return `Ты HR business partner. Верни только JSON без markdown: {"title":"","department":"","level":"","purpose":"","responsibilities":[""],"mustHave":[""],"niceToHave":[""],"softSkills":[""],"kpi":[""],"salaryRange":"","education":"","tools":[""],"notes":""} Описание вакансии:\n${text}`; }
